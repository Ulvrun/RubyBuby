...
vlad_client   = Client.new('Vlad', 'Skrishevskiy', 31, :male, 178, 80)
...
vlad_bmi = vlad_trainer.calc_body_mass_index(vlad_client)

vlad_trainer.prepare_diet_tips(zhenya_bmi)
vlad_trainer.prepare_diet_tips(irina_bmi)
vlad_trainer.prepare_diet_tips(vlad_bmi)